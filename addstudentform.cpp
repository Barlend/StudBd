...
void AddStudentForm::on_AddSudentButton_clicked()
{
    ...
    addStudentQuery.prepare("insert into Students (Name, FirstName, LastName, NumberOfGroup, IdOfFaculties, IdOfDepartment, Telephone, MotherName, FatherName, ParentsPhone, DateOfBirth, DateOfEntry, EndDate)"
                            "values(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
